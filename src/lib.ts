...
export function game_new(size: number = GAME_SIZE): Game {
...
export function game_field_init(game: Game, { selector }: PresentationProps) {
...
export function game_field_add_emoji(game: Game) {
...
export function game_field_move(game: Game, direction: Direction) {
  if (game.is_finished) {
    return
  }
